 ...
 * <code>{@link gatewayapps.crondroid.JobDetail}</code> executes. In general,
...
public interface JobListener {
    ...
    /**
     * <p>
     * Called by the <code>{@link Scheduler}</code> when a <code>{@link gatewayapps.crondroid.JobDetail}</code>
    ...
    /**
     * <p>
     * Called by the <code>{@link Scheduler}</code> after a <code>{@link gatewayapps.crondroid.JobDetail}</code>
