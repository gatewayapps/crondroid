...
public class TriggerUtils {
     ...
     */
    public static List<Date> computeFireTimes(OperableTrigger trigg, gatewayapps.crondroid.Calendar cal,
            int numTimes) {
     ...
     */
    public static Date computeEndTimeToAllowParticularNumberOfFirings(OperableTrigger trigg, gatewayapps.crondroid.Calendar cal,
            int numTimes) {
    ...
    public static List<Date> computeFireTimesBetween(OperableTrigger trigg,
            gatewayapps.crondroid.Calendar cal, Date from, Date to) {
        LinkedList<Date> lst = new LinkedList<Date>();
