 ...
 * by which the <code>{@link gatewayapps.crondroid.core.QuartzScheduler}</code> can
 * reliably determine the current time.
 * </p>
 * 
 * <p>
 * In general, the default implementation of this interface (<code>{@link gatewayapps.crondroid.simpl.SimpleTimeBroker}</code>-
