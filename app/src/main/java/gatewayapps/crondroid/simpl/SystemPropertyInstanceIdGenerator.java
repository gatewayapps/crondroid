 ...
 * 
 * If no value set for the property, a {@link gatewayapps.crondroid.SchedulerException} is thrown
 *
 * @author Alex Snaps
 */
public class SystemPropertyInstanceIdGenerator implements InstanceIdGenerator {
   ...
   */
  public static final String SYSTEM_PROPERTY = "gatewayapps.crondroid.scheduler.instanceId";
