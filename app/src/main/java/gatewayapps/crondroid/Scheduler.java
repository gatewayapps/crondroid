...
import gatewayapps.crondroid.spi.JobFactory;
import gatewayapps.crondroid.utils.Key;

/**
 * This is the main interface of a Quartz Scheduler.
 * 
 * <p>
 * A <code>Scheduler</code> maintains a registry of <code>{@link gatewayapps.crondroid.JobDetail}</code>s
 ...
 * a class that implements the <code>{@link gatewayapps.crondroid.Job}</code>
...
public interface Scheduler {
     ...
     *
     * @see gatewayapps.crondroid.JobDetail#requestsRecovery()
     */
     ...
     * </p>
     * 
     * @see gatewayapps.crondroid.spi.JobFactory
     */
    ...
    /**
     * Add the given <code>{@link gatewayapps.crondroid.JobDetail}</code> to the
    ...
    /**
     * Schedule the given <code>{@link gatewayapps.crondroid.Trigger}</code> with the
    ...
    /**
     * Trigger the identified <code>{@link gatewayapps.crondroid.JobDetail}</code>
     * (execute it now).
     */
     ...
     * @see #resumeJobs(gatewayapps.crondroid.impl.matchers.GroupMatcher)
     */
     ...
     * @param matcher The matcher to evaluate against know groups
     * @throws SchedulerException
     * @see #resumeTriggers(gatewayapps.crondroid.impl.matchers.GroupMatcher)
     */
    ...
    /**
     * Get the names of all known <code>{@link gatewayapps.crondroid.JobDetail}</code>
     * groups.
     */
    List<String> getJobGroupNames() throws SchedulerException;

    /**
     * Get the keys of all the <code>{@link gatewayapps.crondroid.JobDetail}s</code>
     ...
     * identified <code>{@link gatewayapps.crondroid.JobDetail}</code>.
     * 
