...
/**
 * <p>
 * The interface to be implemented by classes that want to provide a <code>{@link gatewayapps.crondroid.Job}</code>
 * and <code>{@link gatewayapps.crondroid.Trigger}</code> storage mechanism for the
 * <code>{@link gatewayapps.crondroid.core.QuartzScheduler}</code>'s use.
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see gatewayapps.crondroid.core.QuartzScheduler
 * @see gatewayapps.crondroid.Trigger
 * @see gatewayapps.crondroid.Job
 * @see gatewayapps.crondroid.JobDetail
 * @see gatewayapps.crondroid.JobDataMap
 * @see gatewayapps.crondroid.Calendar
 *
 * @author James House
 * @author Eric Mueller
 */
public interface JobStore {
    ...
    /**
     * Store the given <code>{@link gatewayapps.crondroid.JobDetail}</code>.
     *
     * @param newJob
     *          The <code>JobDetail</code> to be stored.
     ...
     * key, and any <code>{@link gatewayapps.crondroid.Trigger}</code> s that reference
     * it.
     *
     * <p>
    ...
    /**
     * Get the number of <code>{@link gatewayapps.crondroid.Job}</code> s that are
    ...
    /**
     * Get the keys of all of the <code>{@link gatewayapps.crondroid.Job}</code> s that
    ...
    /**
     * Pause the <code>{@link gatewayapps.crondroid.Trigger}</code> with the given key.
     *
    ...
    /**
     * Pause all of the <code>{@link gatewayapps.crondroid.Trigger}s</code> in the
     * given group.
     *
     *
     * <p>
    ...
    /**
     * Pause the <code>{@link gatewayapps.crondroid.Job}</code> with the given name - by
    ...
    /**
     * Pause all of the <code>{@link gatewayapps.crondroid.Job}s</code> in the given
    ...
    /**
     * Resume (un-pause) the <code>{@link gatewayapps.crondroid.Trigger}</code> with the
     * given key.
     *
     * <p>
    ...
    /**
     * Resume (un-pause) all of the <code>{@link gatewayapps.crondroid.Trigger}s</code>
     * in the given group.
     *
     * <p>
    ...
    /**
     * Resume (un-pause) the <code>{@link gatewayapps.crondroid.Job}</code> with the
     * given key.
     *
     * <p>
    ...
    /**
     * Resume (un-pause) all of the <code>{@link gatewayapps.crondroid.Job}s</code> in
     * the given group.
     *
     * <p>
     ...
     * and that the <code>{@link gatewayapps.crondroid.JobDataMap}</code>
