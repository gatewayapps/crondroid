 ...
 * </p>
 * 
 * @see gatewayapps.crondroid.Scheduler#setJobFactory(JobFactory)
 * @see gatewayapps.crondroid.simpl.SimpleJobFactory
 * @see gatewayapps.crondroid.simpl.PropertySettingJobFactory
 * 
 * @author James House
 */
