...
import gatewayapps.crondroid.DisallowConcurrentExecution;
import gatewayapps.crondroid.Job;
import gatewayapps.crondroid.JobBuilder;
...
import gatewayapps.crondroid.PersistJobDataAfterExecution;
import gatewayapps.crondroid.Scheduler;
import gatewayapps.crondroid.StatefulJob;
import gatewayapps.crondroid.Trigger;
import gatewayapps.crondroid.utils.ClassUtils;
...
public class JobDetailImpl implements Cloneable, java.io.Serializable, JobDetail {
    ...
    */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.JobDetailI#getKey()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.JobDetailI#getDescription()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.JobDetailI#getJobClass()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.JobDetailI#getJobDataMap()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.JobDetailI#isDurable()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.JobDetailI#requestsRecovery()
     */
