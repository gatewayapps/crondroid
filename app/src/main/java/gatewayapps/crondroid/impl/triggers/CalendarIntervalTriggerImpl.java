...
import gatewayapps.crondroid.CalendarIntervalScheduleBuilder;
import gatewayapps.crondroid.CalendarIntervalTrigger;
import gatewayapps.crondroid.CronTrigger;
import gatewayapps.crondroid.DateBuilder.IntervalUnit;
...
/**
 * <p>A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link gatewayapps.crondroid.JobDetail}</code>
 ...
 * (see {@link #setRepeatIntervalUnit(gatewayapps.crondroid.DateBuilder.IntervalUnit)}) as specified in the trigger's definition.
...
public class CalendarIntervalTriggerImpl extends AbstractTrigger<CalendarIntervalTrigger> implements CalendarIntervalTrigger, CoreTrigger {
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.DateIntervalTriggerI#getRepeatIntervalUnit()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.DateIntervalTriggerI#getRepeatInterval()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.CalendarIntervalTriggerI#getTimeZone()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.DateIntervalTriggerI#getTimesTriggered()
     */
    ...
    /**
     *  
     * @see gatewayapps.crondroid.spi.OperableTrigger#updateWithNewCalendar(gatewayapps.crondroid.Calendar, long)
     */
    @Override
