...
import gatewayapps.crondroid.DailyTimeIntervalScheduleBuilder;
import gatewayapps.crondroid.DailyTimeIntervalTrigger;
import gatewayapps.crondroid.DateBuilder;
...
import gatewayapps.crondroid.TimeOfDay;
import gatewayapps.crondroid.Trigger;
import gatewayapps.crondroid.DateBuilder.IntervalUnit;

/**
 * A concrete implementation of DailyTimeIntervalTrigger that is used to fire a <code>{@link gatewayapps.crondroid.JobDetail}</code>
 ...
 * (see {@link #setRepeatIntervalUnit(gatewayapps.crondroid.DateBuilder.IntervalUnit)}) during a given time window on specified days of the week.</p>
 * 
...
public class DailyTimeIntervalTriggerImpl extends AbstractTrigger<DailyTimeIntervalTrigger> implements DailyTimeIntervalTrigger, CoreTrigger {
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.DailyTimeIntervalTriggerI#getRepeatIntervalUnit()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.DailyTimeIntervalTriggerI#getRepeatInterval()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.DailyTimeIntervalTriggerI#getTimesTriggered()
     */
    ...
    /**
     * @see gatewayapps.crondroid.impl.triggers.AbstractTrigger#updateWithNewCalendar(gatewayapps.crondroid.Calendar, long)
     */
    @Override
