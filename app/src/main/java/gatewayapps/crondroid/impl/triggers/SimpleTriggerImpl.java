...
import gatewayapps.crondroid.SimpleScheduleBuilder;
...
public class SimpleTriggerImpl extends AbstractTrigger<SimpleTrigger> implements SimpleTrigger, CoreTrigger {
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.SimpleTriggerI#getRepeatCount()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.SimpleTriggerI#getRepeatInterval()
     */
