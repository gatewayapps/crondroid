...
import gatewayapps.crondroid.CronTrigger;
...
import gatewayapps.crondroid.ScheduleBuilder;
import gatewayapps.crondroid.Scheduler;
import gatewayapps.crondroid.SchedulerException;
import gatewayapps.crondroid.SimpleTrigger;
import gatewayapps.crondroid.Trigger;
import gatewayapps.crondroid.TriggerBuilder;
import gatewayapps.crondroid.TriggerKey;
import gatewayapps.crondroid.TriggerUtils;
...
public abstract class AbstractTrigger<T extends Trigger> implements OperableTrigger {
    ...
    */
    ...
    /**
     * <p>
     * Create a <code>Trigger</code> with no specified name, group, or <code>{@link gatewayapps.crondroid.JobDetail}</code>.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Get the name of the associated <code>{@link gatewayapps.crondroid.JobDetail}</code>.
     * </p>
     */
    ...
    /**
     * <p>
     * Set the name of the associated <code>{@link gatewayapps.crondroid.JobDetail}</code>.
     * </p>
     * 
     * @exception IllegalArgumentException
    ...
    /**
     * <p>
     * Get the name of the associated <code>{@link gatewayapps.crondroid.JobDetail}</code>'s
     * group.
     * </p>
     */
    ...
    /**
     * <p>
     * Set the name of the associated <code>{@link gatewayapps.crondroid.JobDetail}</code>'s
     * group.
     * </p>
     * 
     ...
     * <code>{@link gatewayapps.crondroid.JobDetail}</code> associated with the <code>Trigger</code>
     ...
     * 
     * @see gatewayapps.crondroid.Trigger.CompletedExecutionInstruction
     ...
     * may remove the <code>Trigger</code> from the <code>{@link gatewayapps.crondroid.spi.JobStore}</code>.
     * </p>
     */
     ...
     * </p>
     * 
     * @see TriggerUtils#computeEndTimeToAllowParticularNumberOfFirings(gatewayapps.crondroid.spi.OperableTrigger, gatewayapps.crondroid.Calendar, int)
     */ 
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(gatewayapps.crondroid.spi.OperableTrigger, gatewayapps.crondroid.Calendar, Date, Date)
     */
     ...
     * 
     * <p>
     * Usable by <code>{@link gatewayapps.crondroid.spi.JobStore}</code>
