...
import gatewayapps.crondroid.CronScheduleBuilder;
...
/**
 * <p>
 * A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link gatewayapps.crondroid.JobDetail}</code>
...
public class CronTriggerImpl extends AbstractTrigger<CronTrigger> implements CronTrigger, CoreTrigger {
     ...
     * associated with the identified <code>{@link gatewayapps.crondroid.JobDetail}</code>.
     * </p>
     * 
     * <p>
     * The start-time will also be set to the current time, and the time zone
     ...
     *          of the <code>Trigger</code>
     * @param jobName
     *          name of the <code>{@link gatewayapps.crondroid.JobDetail}</code>
     *          executed on firetime
     * @param jobGroup
     *          group of the <code>{@link gatewayapps.crondroid.JobDetail}</code>
     *          executed on firetime
     * @param startTime
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.CronTriggerI#getCronExpression()
     */
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.CronTriggerI#getTimeZone()
     */
     ...
     * gatewayapps.crondroid.Calendar (if any)
     * </p>
     */
    @Override
     ...
     * not validated against gatewayapps.crondroid.calendar
     * </p>
     */
    @Override
     ...
     */
    @Override
    public void updateAfterMisfire(gatewayapps.crondroid.Calendar cal) {
     ...
     */
    @Override
    public void triggered(gatewayapps.crondroid.Calendar calendar) {
    ...
    /**
     *  
     * @see AbstractTrigger#updateWithNewCalendar(gatewayapps.crondroid.Calendar, long)
     */
    @Override
    public void updateWithNewCalendar(gatewayapps.crondroid.Calendar calendar, long misfireThreshold)
    {
     ...
     */
    @Override
    public Date computeFirstFireTime(gatewayapps.crondroid.Calendar calendar) {
    ...
    /* (non-Javadoc)
     * @see gatewayapps.crondroid.CronTriggerI#getExpressionSummary()
     */
