package gatewayapps.crondroid.impl.calendar;
 ...
 * as, for example, {@link gatewayapps.crondroid.impl.calendar.WeeklyCalendar
...
public class DailyCalendar extends BaseCalendar {
     ...
     *                          time range
     */
    public DailyCalendar(gatewayapps.crondroid.Calendar baseCalendar,
     ...
     * <code>{@link TimeZone#getDefault()}</code> time zone unless an explicit 
     * time zone is set via <code>{@link BaseCalendar#setTimeZone(TimeZone)}</code>.
     * You should use <code>{@link #DailyCalendar(gatewayapps.crondroid.Calendar, TimeZone, long, long)}</code>
