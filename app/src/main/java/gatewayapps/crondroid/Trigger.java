...
public interface Trigger extends Serializable, Cloneable, Comparable<Trigger> {
     ...
     * <code>{@link Trigger}</code> wants the <code>{@link gatewayapps.crondroid.JobDetail}</code> to
     ...
     * that all <code>Trigger</code>s referencing the same <code>{@link gatewayapps.crondroid.JobDetail}</code>
     ...
     * <code>Trigger</code>s referencing the same <code>{@link gatewayapps.crondroid.JobDetail}</code> as
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(gatewayapps.crondroid.spi.OperableTrigger, Calendar, Date, Date)
     */
